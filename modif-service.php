                                        ...
                                        <form action="controller/modifService.php?id=<?php echo $donnees['id'];?>" method="post">
                                                ...
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text"  value="<?php echo $donnees['titre'] ?>" name="titre" id="example-text-input">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="example-number-input" class="form-label">Prix</label>
                                                        <input class="form-control" type="number"  value="<?php echo $donnees['prix'] ?>" name="prix" id="example-number-input">
                                                    </div>
