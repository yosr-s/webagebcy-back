                            ...
                            <form action="controller/modifAdmin.php?id=<?php echo $donnees['id'];?>" method="post">
                                                ...
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="<?php echo $donnees['nom'] ?>" name="nom"
                                                         id="example-text-input">
                                                    </div>

                                                     <div class="mb-3">
                                                        <label for="example-text-input" class="form-label">Prénom</label>
                                                        <input class="form-control" type="text" value="<?php echo $donnees['prenom'] ?>" name="prenom"
                                                          id="example-text-input">
                                                    </div>

                                                     <div class="mb-3">
                                                        <label for="example-text-input" class="form-label">Login</label>
                                                        <input class="form-control" type="text" value="<?php echo $donnees['login'] ?>" name="login" id="example-text-input">
                                                    </div>
