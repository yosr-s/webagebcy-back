                                                ...
                                                <div>
                                                    ...
                                                    <div class="mb-3">
                                                     ...
                                                     <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" value="<?php echo $donnees['sujet'] ?>" name="sujet" id="example-text-input">
                                                    </div>

                                                     <div class="mb-3">
                                                        <label for="example-number-input" class="form-label">Message</label>
                                                       <textarea class="form-control"  name="message"><?php echo $donnees['message'] ?></textarea>
                                                    </div>
